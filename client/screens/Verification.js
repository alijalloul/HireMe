    ...
    <View className="flex-1 justify-center bg-white">
      ...
      >
        ...
        <View className="flex justify-center items-center mb-16">
          <Text className="text-[#FE6F07] font-garamond-bold text-4xl">
            {translateText(
              "Verification Code",
              "رمز التحقق"
            )}
          ...
          <View className="flex justify-center items-center mb-3">
            <Text className=" font-garamond text-[16px]">
              {translateText(
                "Please enter the code sent to",
                "الرجاء إدخال الرمز المرسل إليه"
              )}
            </Text>
            <Text className=" font-garamond text-[#FE6F07] text-[16px]">
              {phoneNumber}
            </Text>
          </View>
          ...
          >
            <Text className=" font-garamond opacity-50 border-b-[0.5px]">
              {translateText(
                "Change Phone Number",
                "تغيير رقم الهاتف"
              )}
        ...
        <View className="relative w-[90%]">
          ...
          >
            <Text className="text-white font-garamond-bold text-xl">
