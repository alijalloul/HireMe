      ...
      <View className="flex-1 items-center w-full">
        ...
        <View className="w-[90%]">
          <View className=" my-5 flex-1">
            <Text className=" font-garamond-semibold text-2xl">
              {translateText(
                "Contact Information",
                "معلومات الاتصال"
              )}
    ...
    return (
      <View className="flex-1 items-center w-full">
        ...
        <View className="w-[90%]">
          ...
          <View className="my-5">
            <Text className=" font-garamond-semibold text-2xl mb-4">
              {translateText(
                "My CV",
                "سيرتي الذاتية"
              )}
            ...
            <View className="flex flex-row justify-between items-center">
              ...
              >
                <Text className=" font-garamond text-[15px] text-red-500">
                  {translateText(
                    "Remove",
                    "إزالة"
                  )}
      ...
      >
        ...
        <View className="w-[90%] justify-center">
          ...
          >
            ...
            >
              <Text className="text-lg font-garamond text-[#FE6F07]">
                {translateText(
                  "Log Out",
                  "تسجيل الخروج"
                )}
