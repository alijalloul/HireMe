...
const Choose = ({ navigation }) => {
  ...
  const JobCardBackgroundAnimation =
    useDynamicAnimation(() => {
      return {
  ...
  const JobTextBackgroundAnimation =
    useDynamicAnimation(() => {
      return {
        color: "black",
      };
  ...
  const ClientCardBackgroundAnimation =
    useDynamicAnimation(() => {
      return {
        backgroundColor: "white",
        borderColor: "black",
  ...
  const ClientTextBackgroundAnimation =
    useDynamicAnimation(() => {
      return {
        color: "black",
      };
  ...
  return (
    <View className="flex-1 bg-white items-center">
      <View className="my-5 flex justify-center items-center">
        <Text
          className={`font-garamond text-sm text-red-500 ${
            !error && "hidden"
          }`}
        >
          {translateText(
        ...
        <Text className="text-[40px] font-garamond">
          {translateText(
            "I am looking for...",
            "أبحث عن..."
          )}
        ...
        <View className="w-full h-full ">
          ...
          >
            <MotiText
              ...
              className=" font-garamond text-[40px]"
            >
